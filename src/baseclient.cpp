...
BaseClient::BaseClient(bool _active, mylib::port_type _local_port, const std::vector<ProxyEndpoint> &_proxy_endpoints, const int _max_connections, PluginHandler &_plugin)
:	m_proxy_index(0),
	m_active(_active),
